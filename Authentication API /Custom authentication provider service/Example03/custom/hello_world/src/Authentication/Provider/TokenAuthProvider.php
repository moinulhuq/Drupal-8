...
namespace Drupal\hello_world\Authentication\Provider;
...
class TokenAuthProvider implements AuthenticationProviderInterface {
  ...
  public function authenticate(Request $request) {
    if ($this->isCorrect($request->query->get('token'))) {
  ...
  /**
   * Checks whether token is correct.
   *
   * @param $token.
   *
   * @return bool
   ...
   */
  public function isCorrect($token) {
    $result = \Drupal::entityQuery('token_auth')
